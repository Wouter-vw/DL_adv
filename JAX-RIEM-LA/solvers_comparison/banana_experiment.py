...
def main(args):
    ...
    if args.savefig:
        savepath = f"plots_seed_{args.seed}_linearized_{args.linearized_pred}_samples_{args.samples}_optimize_prior_{args.optimize_prior}_diffrax_{args.diffrax}_solver_{args.solver}_pcoeff_{args.pcoeff}_icoeff_{args.icoeff}_kfac_{args.kfac}_epochs_{args.epochs}"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--icoeff", "-icoeff", type=float, default=0.3, help="icoeff")
